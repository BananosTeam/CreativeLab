...
- (void)setup:(NSLayoutConstraint * _Nonnull)bottomLayoutConstraint view:(UIView * _Nonnull)view minMargin:(CGFloat)minMargin bottomLayoutGuide:(id <UILayoutSupport> _Nullable)bottomLayoutGuide;
@end
...
@property (nonatomic, copy) void (^ _Nullable willAnimateKeyboard)(CGFloat height);

/// Function that will be called inside the animation block. This can be used to call layoutIfNeeded on the view.
@property (nonatomic, copy) void (^ _Nullable animateKeyboard)(CGFloat height);
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
